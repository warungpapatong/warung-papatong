...
/**
 * LocationSection — Seksi lokasi & kontak.
 * Server Component: tidak ada interactivity, cukup static markup.
 */
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <a
                ...
                onClick={() => trackWhatsAppConversion('Location Section WhatsApp Chat')}
