...
// ✅ Semua konten (badge, heading, deskripsi, CTA, caption kartu) ada di HTML
//    → Google bot crawl langsung tanpa eksekusi JS
// ✅ Client logic diisolasi di:
//    - AmbienceCard.tsx → whileInView scroll animation per kartu
// ─────────────────────────────────────────────────────────────────────────────
...
export default function AmbienceTeaser() {
  return (
    ...
    >
      {/* Ambient blobs — pure CSS, zero JS */}
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* ── Left: text — pure server HTML, crawlable ── */}
          ...
          {/* ── Right: image cards ── */}
          {/*
            Setiap kartu dibungkus AmbienceCard (Client Component) untuk
            whileInView animation. Tapi caption, desc, brandLabel — semua
            dikirim sebagai props dari server, sehingga tetap ada di HTML.
          */}
