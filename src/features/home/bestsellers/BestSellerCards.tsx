...
import { PRODUCTS_DATA, formatProductPrice } from '@/data'
          ...
          >
            ...
            <div className="p-6 md:p-8 flex flex-col flex-grow justify-between gap-3">
              ...
              <div className="pt-4 border-t border-brand-border flex items-center justify-between">
                ...
                <Link
                  href={ctaHref}
                  className="text-xs font-mono font-extrabold text-brand-dark hover:text-brand-primary flex items-center gap-1 transition-colors"
                >
                  {detailCtaText}
